...
python ./rlaif/gpt2/summarization/tldr/train_rm.py \
--model_name_or_path "./rlaif/gpt2/summarization/tldr/exps/sft/2024-12-29 18:26:08.039195/checkpoint-1824" \
--dataset_name  "./rlaif/gpt2/summarization/tldr/exps/ai_feedback_preference_dataset/full-train-split-14776samples/preference_ds_two_orders_implicit" \
--output_dir "./rlaif/gpt2/summarization/tldr/exps/rm" \
...
if __name__ == "__main__":
    ...
    assert "soft_label_chosen" in dataset.features
    if not customized_args.use_soft_label:
        dataset = dataset.remove_columns(["soft_label_chosen"])
    else:
        pass
    ...
    if model_config.use_peft:
        trainer.model.print_trainable_parameters() # lora: trainable params: 5,899,520 || all params: 779,932,160 || trainable%: 0.7564
    else:
